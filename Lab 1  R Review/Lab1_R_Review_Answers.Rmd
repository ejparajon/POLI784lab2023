---
title: '784 Lab 1: R Refresher: Answer Key'
author: "Eric Parajon"
output:
  html_document:
    df_print: paged
...
#looks there there could be a positive relationship between Examination and Education 
# as Examination score increases, Education also increases
...
4. What are the eigenvectors (vector whose direction remains unchanged when a linear transformation is applied to it) and eigenvalues (scalars associated with a linear system of equations) of this new matrix? 
...
#verifying that they are eigenvalues by checking that det(AB−λiI)=0 for each value
