...
knitr::opts_chunk$set(cache = TRUE, include = FALSE, echo=TRUE)
...
# Part 3: LM practice
Using the palmerpenguines dataset, create an OLS using multiple predictors and then display the results in a publication quality table (using stargazer).
```{r}
...
stargazer(bill_model,title="Effect of Predictors on Bill Length",digits=3,star.cutoffs = c(0.1,0.05,0.01),
          ...
          notes="\\parbox[t]{12cm}{Coefficients reported from OLS regression models. Significance codes:*$<$ 0.10,**p$<$ 0.05, ***p$<$ 0.01, two-tailed tests.}",
          notes.append=FALSE,
          style="apsr",
          dep.var.caption = c(""),
