---
title: 'Lab 7: Missing Data and Imputation:Answers'
author: "Eric Parajon"
header-includes:
...
#let's take a look!
invlogit #no parentheses from the arm package
...
Generate an average predicted effect over the observed values of income for the first model. Plot this too.
...
sim_betas_m1 <- mvrnorm(______)

#getting range of income
income_vec <- seq(from = ______,
                  length.out = 100)
