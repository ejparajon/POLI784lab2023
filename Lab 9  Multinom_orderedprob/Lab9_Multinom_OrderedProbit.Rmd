---
title: 'Lab 9: Multinomial and Ordered Probit Models'
author: "Eric Parajon"
output:
  html_document:
    df_print: paged
...
```{r}
tau1 <- m1$alpha[1] #extract latent thresholds (calculated w polr) from our model!
tau2 <- m1$alpha[2]
p1 <- invlogit(tau1) # 1
...
#Check the proportional odds assumption for a variable
...
probs <- predict(____, type = "prob") #type = is different than for binomial model
...
#Generate a cumulative predicted probability plot varying by age
