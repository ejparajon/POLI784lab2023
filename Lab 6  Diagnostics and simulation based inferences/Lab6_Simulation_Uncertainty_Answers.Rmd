...
t(apply(samp_beta_guns, 2, quantile, prob = c(.1, .9)))
  #Method 2
CI<-confint(guns_model, level = .8)

CI


#Now doing the Monte Carlo inference for average prediction
# to get the predicted robbery rate as the population density varies from its 10th percentile to its 90th percentile dependent on if a shall carry law is in effect
